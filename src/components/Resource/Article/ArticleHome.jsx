...
const ArticleHome = () => {
  ...
  return (
    <div className=" h-screen relative min-h-screen bg-cover bg-center flex items-center justify-center text-white" style={{ backgroundImage: 'url(https://res.cloudinary.com/dnjis096o/image/upload/v1717236252/haa6ignomxyykdnyi4rg.jpg)' }}>
